...
VL_ATTR_COLD void Vaxi_crossbar_2m3s_tb___024unit___ctor_var_reset(Vaxi_crossbar_2m3s_tb___024unit* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxi_crossbar_2m3s_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vaxi_crossbar_2m3s_tb___024unit___ctor_var_reset\n"); );
}
