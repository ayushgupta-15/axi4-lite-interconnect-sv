...
VL_ATTR_COLD void Vaxi_crossbar_tb_axi4_lite_if___eval_static__TOP__axi_crossbar_tb__DOT__axi(Vaxi_crossbar_tb_axi4_lite_if* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vaxi_crossbar_tb_axi4_lite_if___eval_static__TOP__axi_crossbar_tb__DOT__axi\n"); );
    // Body
    vlSelf->__PVT__outstanding_writes = 0U;
    vlSelf->__PVT__outstanding_reads = 0U;
}

VL_ATTR_COLD void Vaxi_crossbar_tb_axi4_lite_if___ctor_var_reset(Vaxi_crossbar_tb_axi4_lite_if* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxi_crossbar_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vaxi_crossbar_tb_axi4_lite_if___ctor_var_reset\n"); );
    // Body
